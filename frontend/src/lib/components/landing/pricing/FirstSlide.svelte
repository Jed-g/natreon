...
<div class="flex flex-col items-center relative select-none background-image" id="home">
    <div class="w-5/6 py-4">
        ...
        <p class="text-lg text-white text-center mb-4">
            ...
            Donations at this stage are greatly appreciated but not necessary.
        </p>
        ...
        <div class="grid grid-rows-4 grid-cols-3 gap-2">
            ...
            <div>
                ...
                <div class="collapse bg-base-200" on:click={(e) => console.log("AffliatePricingClick", e)}>
                    <input type="checkbox" />
                ...
                <div>
                    <form>
                        ...
                        <div class="flex items-center space-x-1 mb-2">
                            ...
                            <input type="number" id="donationAmount" name="donationAmount" class="border rounded-md p-2 w-20" readonly value="5" />
                        </div>
            ...
            <div>
				<!-- svelte-ignore a11y-click-events-have-key-events -->
				<!-- svelte-ignore a11y-no-static-element-interactions -->
                <div class="collapse bg-base-200" on:click={(e) => console.log("ActivitiesPricingClick", e)}>
                    <input type="checkbox" />
                ...
                <div>
                    <form>
                        ...
                        <div class="flex items-center space-x-1 mb-2">
                            <span class="text-white">£</span>
                            <input type="number" id="donationAmount" name="donationAmount" class="border rounded-md p-2 w-20" readonly value="10" />
                        </div>
                        <button class="btn btn-primary">Donate</button>
                    </form>
                </div>
            ...
            <div>
                ...
                <div>
                    <form>
                        ...
                        <div class="flex items-center space-x-1 mb-2">
                            <span class="text-white">£</span>
                            <input type="number" id="donationAmount" name="donationAmount" class="border rounded-md p-2 w-20" readonly value="15" />
                        </div>
                        <button class="btn btn-primary">Donate</button>
                    </form>
                </div>
