// Define the pointsOfInterest variable
export const pointsOfInterest: { 
    ...
    description: string; 
    features: string[] 
    comments: string[]; // Add the 'comments' array here
}[] = [
    ...
    {
        lngLat: { lng: -1.48985, lat: 53.38247 },
        name: 'Weston Park',
        id: 'westonparksheffield',
        description: 'Tranquil urban park area offering picnic areas, a bandstand, statues & a duck & fish pond.',
        features: [
