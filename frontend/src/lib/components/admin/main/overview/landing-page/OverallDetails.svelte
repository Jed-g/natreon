...
<div class="flex grow flex-col">
	...
	{#if loading}
		{#if showSystemDetails}
			<div class="grow flex items-center justify-center card bg-base-300 p-6 sm:hidden">
				<span class="loading loading-ring loading-lg" />
			</div>
		{/if}
		<div class="grow sm:flex items-center justify-center card bg-base-300 p-6 hidden">
			<span class="loading loading-ring loading-lg" />
		</div>
	{:else}
