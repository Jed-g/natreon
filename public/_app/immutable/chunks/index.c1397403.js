import{R as b,S as m}from"./scheduler.e7e8979b.js";function h(t){return t<.5?4*t*t*t:.5*Math.pow(2*t-2,3)+1}function k(t){return t*t*t}function $(t){const n=t-1;return n*n*n+1}function C(t,{delay:n=0,duration:o=400,easing:s=b}={}){const r=+getComputedStyle(t).opacity;return{delay:n,duration:o,easing:s,css:e=>`opacity: ${e*r}`}}function x(t,{delay:n=0,duration:o=400,easing:s=$,x:r=0,y:e=0,opacity:c=0}={}){const a=getComputedStyle(t),f=+a.opacity,u=a.transform==="none"?"":a.transform,y=f*(1-c),[l,i]=m(r),[d,g]=m(e);return{delay:n,duration:o,easing:s,css:(p,_)=>`
		...
		`}}export{x as a,k as b,$ as c,w as d,C as f,I as s};
