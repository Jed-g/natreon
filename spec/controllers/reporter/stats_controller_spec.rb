    ...
    describe '#all_visits' do
        ...
        context 'when the user is an reporter' do
            ...
            it 'returns JSON data with all and unique visit details' do
                ...
                create(:landing_page_visit, country: 'Country B', created_at: 1.day.ago, time_spent_seconds: 180, email_of_registered_user: nil)
                create(:landing_page_visit, country: 'Country A', created_at: 3.days.ago, time_spent_seconds: 90, email_of_registered_user: 'user2@example.com')
