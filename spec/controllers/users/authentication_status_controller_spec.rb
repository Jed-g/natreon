...
RSpec.describe Users::AuthenticationStatusController, type: :controller do
  describe 'GET #index' do
    context 'when the user is authenticated' do
      ...
      it 'returns the user type' do
        expect(JSON.parse(response.body)['userType']).to eq(true)  # Check for boolean value
      end
    end
    ...
    context 'when the user is not authenticated' do
      ...
      it 'returns "Not Authenticated" as the user type' do
        expect(JSON.parse(response.body)['userType']).to eq('Not Authenticated')
      end
    end
  end
end
