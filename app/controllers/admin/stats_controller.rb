...
module Admin
  class StatsController < ApplicationController
    ...
    def all_visits
      ...
      all.map! {|visit| visit[3] = !visit[3].nil?; visit }
    ...
    def route_visits
      ...
      return render json: {routes_visited: counts, registrations: number_of_registrations, total_unique_visits: total_unique_visits}
    end
    ...
    def overall_details
      ...
      render json: {
        ...
        mailing_list_signups: mailing_list_signups,
        customer_users_in_system: customer_users_in_system,
